        ...
        while not self.finish_flag:
            ...
            while not done:
                ...
                if (self.total_step >= self.max_step or self.episode == self.max_episode) and done:
                    ...
                    torch.save(self.agent.dqn.state_dict(), "checkpoint/dqn/dqn_parameters.pth")
                    torch.save(self.agent.target_dqn.state_dict(), "checkpoint/dqn/dqn_target_parameters.pth")
